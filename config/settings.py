...
# naming convention (its IMAP is imap.rediffmailpro.com:993) — a guess,
# not confirmed; override via .env if the actual outgoing server differs.
# Credentials belong in .env only, never committed.
...
# Style photos for the operator mobile entry page (Style.image).
MEDIA_URL = 'media/'
